"""
realized_routing_v100_v2.py — R1 realized routing, NAME-REPLY protocol (v2).
...
OUT_DIR = Path(__file__).resolve().parent / "realized_routing_out_v2"
